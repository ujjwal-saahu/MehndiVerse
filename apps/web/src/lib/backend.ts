 ...
 * that calls the backend directly — client components never see the
 * backend URL or a raw access token; they call our own `/api/auth/*` routes,
 * which read/write httpOnly cookies. See docs/authentication.md#2 and #7.
 */
