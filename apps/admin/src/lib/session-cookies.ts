...
export const ACCESS_TOKEN_COOKIE = "mv_admin_access_token";
export const REFRESH_TOKEN_COOKIE = "mv_admin_refresh_token";

const THIRTY_DAYS_SECONDS = 60 * 60 * 24 * 30;

/** httpOnly + Secure(prod) + SameSite=Lax — never readable by client-side JS.
 * See docs/authentication.md#7. Distinct cookie names from the customer web
 * app so a staff member can be logged into both apps independently in the
